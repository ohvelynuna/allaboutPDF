...
def pdf_to_uneditable(input_pdf_path, output_pdf_path):
    ...
    images = convert_from_path(input_pdf_path, poppler_path=r'C:\Program Files (x86)\poppler-24.07.0\Library\bin')
...
# Example usage
input_pdf_path = r"C:\Users\Study\OneDrive - brightupwards.com.au\Client follow up\Salvator Nguyen\test\02 - Salvator Nguyen_Declaration for Child Related Workers.pdf"
output_pdf_path = r"C:\Users\Study\OneDrive - brightupwards.com.au\Client follow up\Salvator Nguyen\test\output.pdf"
